...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Column Modify</h1>
  </div>
  <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">Column Modify</div>
      <!-- /.panel-heading -->
...
$(document).ready(function() {
	  ...
	  $('button').on("click", function(e){
	    ...
	    if(operation === 'remove'){
	      formObj.attr("action", "/column/remove");
	      
	    }else if(operation === 'list'){
	      //move to list
	      formObj.attr("action", "/column/list").attr("method","get");
	      formObj.empty();
	    }
